...
export default function ContactForm() {
  ...
  // Reset conditional fields when iAm changes
  useEffect(() => {
    setFormData((prev) => ({
      ...prev,
      representedByAgent: '',
      // Optionally, add a field for real estate company if you want to clear it as well
    }));
  }, [iAm]);
      ...
      <div className="form" id="form">
        ...
        >
          <div className="inner-form-container">
            <div className='form-item full-width'>
              {/* <label htmlFor="answers_24670">I am *</label> */}
                 <div className='dropdown-wrapper'>
                  <div className="answer"><select name="answers[24670][answers]" id="answers_24670" className="false select-reset" value={iAm} onChange={(e) => setIAm(e.target.value)}><option value="" disabled>I am</option><option value="Buyer">Buyer</option>
            ...
            {/* Always render both, toggle with .hidden */}
            <div className={['form-item', iAm === 'Agent' ? 'hidden' : ''].join(' ')}>
              ...
              <div className='dropdown-wrapper'>
                <div className="answer">
                  <select
                    ...
                    id="answers_24098"
                    className="false select-reset"
                    value={formData.representedByAgent}
                    onChange={(e) => setFormData((prev) => ({ ...prev, representedByAgent: e.target.value }))}
                  >
